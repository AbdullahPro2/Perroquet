...
- Proposition 1 : rendre l'ensemble du texte du cahier des charges neutres par rapport au genre du joueur ou de la joueuse. Les lecteurs du cahier des charges peuvent etre des femmes, des hommes ou des personnes ne s'identifiant pas aux genres masculin et féminin. 
- Proposition 2 : harmoniser les double quotes et les majuscules sur les termes spéciaux.

# Propositions d'amélioration du jeu

- Proposition 1 : Introduire de l'aléatoire dans les gains/pertes d'abonnés et d'argent. Au bout de quelques runs on comprend vite le principe et vu que les pertes et gains sont toujours les memes, on peut facilement savoir combien on va gagner/perdre et prendre des risques très calculés. Ce qui tue un peu le suspense.
- Proposition 2 : Ajouter un système de notifications qui indique quand on peut acheter un nouvel item dans la boutique (l'onglet est discret, si le joueur n'est pas assez curieux il ne pense pas à l'ouvrir pour voir les différents items proposés)
- Proposition 3 : Proposer un système de bulles lorsqu'on survole les différents thèmes possibles pour un post, avec un texte différent dans la bulle, en fonction du bord politique choisi pour le post. Cela ajoute 5*4 textes à implémenter, ce qui semble raisonnable.
...
Résumer en une phrase ce que vous avez éventuellement appris en jouant : les algorithmes des plateformes influent sur la montée ou la chute des influenceurs.

Autres justifications : le prototype se joue en cliquant sur un lien, tout fonctionne correctement mais certains utilisateurs ont eu un souci vu que les données du jeu sont stockées dans le localstorage du navigateur. Il fallait clear le localstorage à chaque mise à jour mais ce souci a été corrigé. Je n'ai pas eu ce problème là. Les instructions ne sont pas données mais le jeu est très intuitif. 
Je connaissais déjà le fonctionnement des algorithmes utilisés par les plateformes avant de jouer donc je n'ai rien appris de nouveau.
